...
\end{center} 
(one similarly define inner measure as supremum of didjoint closed elementary subsets of $ A $ and can cunstuct Lebesgue measure also but the measure obtained is same for a given $ \mu $)
...
\end{center}
&& \textbf{Borel sets} : sets which are countable union, intersection or complementunion or intersection of open sets, clearly the collection $ \mathscr{B} $ of all 
