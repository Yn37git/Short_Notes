...
\begin{easylist}
	...
	& If $P(z)$ diverges at $z=d$ then it diverges absolutely  for all $|d|<|z|.$
	& If two power series $A(z)=\ddsum{n}{0}{\infty} a_n z^n,\\ B(z)=\ddsum{n}{0}{\infty} b_n z^n$ agree on an infinite sequence ($\neq 0$) converging to zero then they are same i.e. $a_i=b_i \; \forall i.$
	...
	& Radius of convergence of $P(z)=\ddsum{n}{0}{\infty} a_n z^n$ is $R$ then:
	&& $R=\lim_{i\rightarrow\infty}\left|\frac{a_n}{a_{n+1}}\right|.$
	&& $R=\lim_{i\rightarrow\infty}\left|\frac{1}{^n\sqrt{|a_{n}|}}\right|.$
	&& $R=\lim_{i\rightarrow\infty}\left|\frac{1}{\; limsup\;^n\sqrt{|a_{n}|}}\right|.$
